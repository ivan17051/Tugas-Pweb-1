                ...
                <div class="col-md-6">
                    <form role="form" method="post" action="" enctype="multipart/form-data">
                        <div class="form-group">
                            <select class="form-control" id="productSelect" required="" name="kategori"><option value="">Please Select a Product Category</option>
                        ...
                        <button type="submit" name="submit" id="loginSubmit" class="btn btn-success">Add Product</button>
